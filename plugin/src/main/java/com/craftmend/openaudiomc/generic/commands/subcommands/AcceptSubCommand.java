...
public class AcceptSubCommand extends SubCommand {
    ...
    public void onExecute(User sender, String[] args) {
        ...
        NetworkingService service = OpenAudioFabric.getService(NetworkingService.class);
        ...
        OpenAudioFabric.resolveDependency(TaskService.class).runAsync(() -> service.connectIfDown());
